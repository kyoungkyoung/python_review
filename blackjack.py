...
if start == 'y':
    ...
    y_or_no = input("Do you want to play a game of Blackjack? type 'y' or 'n': ")

def currentScore(cardDeck):
...
while y_or_no == 'y':
    ...
    player_score = currentScore(player_card)
    computer_score = currentScore(computer_card)
